...
export function CodeCard({ note, index }: { note: CodeNote; index: number }) {
  return (
    ...
    >
      <div className="flex items-center justify-between px-4 py-2 bg-zinc-900 border-b border-zinc-800" dir="ltr">
      ...
      <div className="flex-1 p-4 md:p-6 text-sm font-mono text-zinc-300 overflow-x-auto relative min-h-[220px]" dir="ltr">
